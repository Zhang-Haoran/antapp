...
import {
  ...
  addCourses,
  updateCourses, removeCourses, getCourses
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    {
      title: <FormattedMessage id="pages.courseTable.name" defaultMessage="name" />,
      dataIndex: 'topic',
      sorter:true,
      render: (dom, entity) => {
        return (
    ...
    {
      title: <FormattedMessage id="pages.courseTable.date" defaultMessage="date" />,
      dataIndex: 'date',
      sorter:true
    },
    {
      title: <FormattedMessage id="pages.courseTable.startTime" defaultMessage="startTime" />,
      dataIndex: 'startTime',
      sorter:true
    },
    {
      title: <FormattedMessage id="pages.courseTable.endTime" defaultMessage="endTime" />,
      dataIndex: 'endTime',
      sorter:true
    },
    {
      title: <FormattedMessage id="pages.courseTable.uniform" defaultMessage="uniform" />,
      dataIndex: 'uniform',
      sorter:true
    },
    {
      title: <FormattedMessage id="pages.courseTable.studio" defaultMessage="studio" />,
      dataIndex: 'studio',
      sorter:true
    },
